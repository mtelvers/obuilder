...
val create : ?proc_mgr:[`Generic] Eio.Process.mgr_ty Eio.Resource.t -> state_dir:string -> config -> t
(** [create ?proc_mgr ~state_dir config] is a sandboxing system that keeps state in [state_dir]
